...
# Advanced Code Blocks [Show Your Code]
...
**Source File (`~/content/snippets/range-include-example.ts`):**

```ts
// [!include ~/content/snippets/range-include-example.ts]
```
...
````mdx
```ts
// [!include ~/content/snippets/range-include-example.ts:import]
// [!include ~/content/snippets/range-include-example.ts:client]

// [!include ~/content/snippets/range-include-example.ts:usage]
```
````
