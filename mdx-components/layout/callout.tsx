...
export function Callout({ children, type, title, className }: CalloutProps) {
  ...
  return (
    <div className={cn("mdx-callout group/callout", className)}>
      <Alert
      ...
      >
        <div className="flex flex-col gap-2.5 w-full">
          <div className="flex items-center gap-2.5">
            <div
              className={cn(
                "p-1 rounded-md bg-background border border-border/50 shadow-sm",
                config.color,
              )}
            >
            ...
            <span
              className={cn(
                "text-[10px] font-mono font-bold uppercase tracking-[0.25em]",
                config.color,
              )}
            >
